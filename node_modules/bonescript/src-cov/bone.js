...
var pinIndex = [ {
    ...
    key: "USR1",
    muxRegOffset: "0x058",
    options: [ "gpmc_a6", "gmii2_txclk", "rgmii2_tclk", "mmc2_dat4", "gpmc_a22", "pr1_mii1_rxd2", "eqep1_index", "gpio1_22" ],
    ball: {
        ZCZ: "U15",
        BSM: "T14"
    }
    ...
    key: "USR2",
    muxRegOffset: "0x05c",
    options: [ "gpmc_a7", "gmii2_rxclk", "rgmii2_rclk", "mmc2_dat5", "gpmc_a23", "pr1_mii1_rxd1", "eqep1_strobe", "gpio1_23" ],
    ball: {
        ZCZ: "T15",
        BSM: "R14"
    }
    ...
    key: "USR3",
    muxRegOffset: "0x060",
    options: [ "gpmc_a8", "gmii2_rxd3", "rgmii2_rd3", "mmc2_dat6", "gpmc_a24", "pr1_mii1_rxd0", "mcasp0_aclkx", "gpio1_24" ],
    ball: {
        ZCZ: "V16",
        BSM: "P14"
    }
    ...
    name: "DGND",
    key: [ "P8_1", "P8_2", "P9_1", "P9_2", "P9_43", "P9_44", "P9_45", "P9_46", "P1_15", "P1_16", "P1_22", "P2_15", "P2_21", "E1_1", "E2_1", "E3_1", "E4_1", "S1_1_1", "S1_2_1", "UT0_1", "UT1_1", "UT5_1", "DSM2_2", "I2C_1", "GPS_2", "GPS_6", "GP0_1", "GP1_1" ]
}, {
    name: "GPIO1_6",
    gpio: 38,
    mux: "gpmc_ad6",
    ...
    muxRegOffset: "0x090",
    options: [ "gpmc_advn_ale", "NA", "timer4", "NA", "NA", "NA", "NA", "gpio2_2" ],
    ball: {
        ZCZ: "R7",
        BSM: "M1"
    }
    ...
    muxRegOffset: "0x094",
    options: [ "gpmc_oen_ren", "NA", "timer7", "NA", "NA", "NA", "NA", "gpio2_3" ],
    ball: {
        ZCZ: "T7",
        BSM: "N1"
    }
    ...
    muxRegOffset: "0x09c",
    options: [ "gpmc_ben0_cle", "NA", "timer5", "NA", "NA", "NA", "NA", "gpio2_5" ],
    ball: {
        ZCZ: "T6",
        BSM: "N3"
    }
    ...
    key: [ "P8_10", "MODE" ],
    muxRegOffset: "0x098",
    options: [ "gpmc_wen", "NA", "timer6", "NA", "NA", "NA", "NA", "gpio2_4" ],
    ball: {
        ZCZ: "U6",
        BSM: "N2"
    }
    ...
    led: [ "wifi", null ],
    muxRegOffset: "0x1b0",
    options: [ "xdma_event_intr0", "NA", "timer4", "clkout1", "spi1_cs1", "pr1_pru1_pru_r31", "EMU2", "gpio0_19" ],
    ball: {
        ZCZ: "A15",
        BSM: "A4"
    }
    ...
    muxRegOffset: "0x0e4",
    options: [ "lcd_hsync", "gpmc_a9", "gpmc_a2", "pr1_edio_data_in3", "pr1_edio_data_out3", "pr1_pru1_pru_r30_9", "pr1_pru1_pru_r31_9", "gpio2_23" ],
    ball: {
        ZCZ: "R5",
        BSM: "F2"
    }
    ...
    key: [ "P8_40", "SERVO_6" ],
    muxRegOffset: "0x0bc",
    options: [ "lcd_data7", "gpmc_a7", "pr1_edio_data_in7", "eqep2_strobe", "pr1_edio_data_out_7", "pr1_pru1_pru_r30_7", "pr1_pru1_pru_r31_7", "gpio2_13" ],
    ball: {
        ZCZ: "T4",
        BSM: "J2"
    }
    ...
    name: "VDD_3V3",
    key: [ "P9_3", "P9_4", "P1_14", "P2_23", "E1_2", "E2_2", "E3_2", "E4_2", "GP0_2", "GP1_2", "S1_1_2", "S1_2_2", "UT0_2", "UT1_2", "UT5_2", "DSM2_1", "I2C_2" ]
}, {
    name: "VDD_5V",
    key: [ "P9_5", "P9_6", "P1_1" ]
}, {
    ...
    muxRegOffset: "0x070",
    options: [ "gpmc_wait0", "mii2_crs", "gpmc_csn4", "rmii2_crs_dv", "mmc1_sdcd", "pr1_mii1_col", "uart4_rxd", "gpio0_30" ],
    ball: {
        ZCZ: "T17",
        BSM: "P15"
    }
    ...
    key: "P9_15",
    muxRegOffset: "0x040",
    options: [ "gpmc_a0", "gmii2_txen", "rgmii2_tctl", "rmii2_txen", "gpmc_a16", "pr1_mii_mt1_clk", "ehrpwm1_tripzone_input", "gpio1_16" ],
    ball: {
        ZCZ: "R13",
        BSM: "T12"
    }
    ...
    key: [ "P9_15B", "P2_20" ],
    muxRegOffset: "0x088",
    options: [ "gpmc_csn3", "gpmc_a3", "rmii2_crs_dv", "mmc2_cmd", "pr1_mii0_crs", "pr1_mdio_data", "gpio2_0" ],
    ball: {
        ZCZ: "T13",
        BSM: "R7"
    }
    ...
    muxRegOffset: "0x15c",
    options: [ "spi0_cs0", "mmc2_sdwp", "i2c1_scl", "ehrpwm0_synci", "pr1_uart0_txd", "pr1_edio_data_in1", "pr1_edio_data_out1", "gpio0_5" ],
    ball: {
        ZCZ: "A16",
        BSM: "A14"
    }
    ...
    muxRegOffset: "0x158",
    options: [ "spi0_d1", "mmc1_sdwp", "i2c1_sda", "ehrpwm0_tripzone_input", "pr1_uart0_rxd", "pr1_edio_data_in0", "pr1_edio_data_out0", "gpio0_4" ],
    ball: {
        ZCZ: "B16",
        BSM: "B14"
    }
    ...
    key: [ "P9_19", "P1_28" ],
    muxRegOffset: "0x17c",
    options: [ "uart1_rtsn", "timer5", "d_can0_rx", "i2c2_scl", "spi1_cs1", "pr1_uart0_rts_n", "pr1_edc_latch1_in", "gpio0_13" ],
    ball: {
        ZCZ: "D17",
        BSM: "A10"
    }
    ...
    key: [ "P9_20", "P1_26" ],
    muxRegOffset: "0x178",
    options: [ "uart1_ctsn", "NA", "d_can0_tx", "i2c2_sda", "spi1_cs0", "pr1_uart0_cts_n", "pr1_edc_latch0_in", "gpio0_12" ],
    ball: {
        ZCZ: "D18",
        BSM: "B10"
    }
    ...
    muxRegOffset: "0x154",
    options: [ "spi0_d0", "uart2_txd", "i2c2_scl", "ehrpwm0B", "pr1_uart_rts_n", "pr1_edio_latch_in", "EMU3", "gpio0_3" ],
    ball: {
        ZCZ: "B17",
        BSM: "B13"
    }
    ...
    muxRegOffset: "0x150",
    options: [ "spi0_sclk", "uart2_rxd", "i2c2_sda", "ehrpwm0A", "pr1_uart_cts_n", "pr1_edio_sof", "EMU2", "gpio0_2" ],
    ball: {
        ZCZ: "A17",
        BSM: "A13"
    }
    ...
    key: "GP1_3",
    muxRegOffset: "0x110",
    options: [ "gmii1_rxer", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_2" ],
    ball: {
        ZCZ: "J15",
        BSM: "E15"
    }
    ...
    key: "GP1_4",
    muxRegOffset: "0x10c",
    options: [ "gmii1_crs", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_1" ],
    ball: {
        ZCZ: "H17",
        BSM: "F14"
    }
    ...
    muxRegOffset: "0x1ac",
    options: [ "mcasp0_ahclkx", "NA", "mcasp0_axr3", "mcasp1_axr1", "NA", "NA", "NA", "gpio3_21" ],
    ball: {
        ZCZ: "A14",
        BSM: "C4"
    }
    ...
    muxRegOffset: "0x180",
    options: [ "uart1_rxd", "mmc1_sdwp", "d_can1_tx", "i2c1_sda", "NA", "pr1_uart0_rxd_mux1", "pr1_pru1_pru_r31_16", "gpio0_14" ],
    ball: {
        ZCZ: "D16",
        BSM: "A11"
    }
    ...
    muxRegOffset: "0x1a4",
    options: [ "mcasp0_fsr", "NA", "mcasp0_axr3", "mcasp1_fsx", "EMU2", "pr1_pru0_pru_r30_5", "pr1_pru0_pru_r31_5", "gpio3_19" ],
    ball: {
        ZCZ: "C13",
        BSM: "B3"
    }
    ...
    muxRegOffset: "0x19c",
    options: [ "mcasp0_ahclkr", "NA", "mcasp0_axr2", "spi1_cs0", "eCAP2_in_PWM2_out", "pr1_pru0_pru_r30_3", "pr1_pru0_pru_r31_3", "gpio3_17" ],
    ball: {
        ZCZ: "C12",
        BSM: "B1"
    }
    ...
    muxRegOffset: "0x194",
    options: [ "mcasp0_fsx", "ehrpwm0B", "NA", "spi1_d0", "mmc1_sdcd", "pr1_pru0_pru_r30_1", "pr1_pru0_pru_r31_1", "gpio3_15" ],
    ball: {
        ZCZ: "B13",
        BSM: "A2"
    }
    ...
    muxRegOffset: "0x198",
    options: [ "mcasp0_axr0", "NA", "NA", "spi1_d1", "mmc2_sdcd", "pr1_pru0_pru_r30_2", "pr1_pru0_pru_r31_2", "gpio3_16" ],
    ball: {
        ZCZ: "D12",
        BSM: "B2"
    }
    ...
    muxRegOffset: "0x190",
    options: [ "mcasp0_aclkx", "ehrpwm0A", "NA", "spi1_sclk", "mmc0_sdcd", "pr1_pru0_pru_r30_0", "pr1_pru0_pru_r31_0", "gpio3_14" ],
    ball: {
        ZCZ: "A13",
        BSM: "A1"
    }
    ...
    muxRegOffset: "0x1a8",
    options: [ "mcasp0_axr1", "eQEP0_index", "mcasp1_axr0", "EMU3", "NA", "NA", "NA", "gpio3_20" ],
    ball: {
        ZCZ: "D13",
        BSM: "C3"
    }
    ...
    key: [ "P9_41B", "P1_20" ],
    muxRegOffset: "0x1b4",
    options: [ "xdma_event_intr1", "NA", "NA", "clkout2", "NA", "NA", "NA", "gpio0_20" ],
    ball: {
        ZCZ: "D14",
        BSM: "B4"
    }
    ...
    muxRegOffset: "0x164",
    options: [ "eCAP0_in_PWM0_out", "uart3_txd", "spi1_cs1", "pr1_ecap0_ecap_capin_apwm_o", "spi1_sclk", "mmc0_sdwp", "xdma_event_intr2", "gpio0_7" ],
    ball: {
        ZCZ: "C18",
        BSM: "C5"
    }
    ...
    muxRegOffset: "0x1a0",
    options: [ "mcasp0_aclkr", "eQEP0A_in", "mcasp0_axr2", "mcasp1_aclkx", "mmc0_sdwp", "pr1_pru0_pru_r30_4", "pr1_pru0_pru_r31_4", "gpio3_18" ],
    ball: {
        ZCZ: "B12",
        BSM: "A3"
    }
    ...
    mux: "USB1_DRVVBUS",
    eeprom: null,
    options: [ "USB1_DRVVBUS", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_13" ],
    ball: {
        ZCZ: "F15",
        BSM: "M14"
    }
    ...
    key: [ "UT0_3", "P1_32" ],
    muxRegOffset: "0x170",
    options: [ "uart0_rxd", "spi1_cs0", "dcan0_tx", "i2c2_sda", "eCAP2_in_PWM2_out", "pr1_pru1_pru_r30_14", "pr1_pru1_pru_r31_14", "gpio1_10" ],
    ball: {
        ZCZ: "E15",
        BSM: "A12"
    }
    ...
    key: [ "UT0_4", "P1_30" ],
    muxRegOffset: "0x174",
    options: [ "uart0_rxd", "spi1_cs1", "dcan0_4x", "i2c2_scl", "eCAP1_in_PWM1_out", "pr1_pru1_pru_r30_15", "pr1_pru1_pru_r31_15", "gpio1_11" ],
    ball: {
        ZCZ: "E16",
        BSM: "B12"
    }
    ...
    key: "P2_10",
    muxRegOffset: "0x050",
    options: [ "gpmc_a4", "gmii2_txd1", "rgmii2_td1", "rmii2_txd1", "gpmc_a20", "pr1_mii1_txd0", "eQEP1A_in", "gpio1_20" ],
    ball: {
        ZCZ: "R14",
        BSM: "R13"
    }
    ...
    key: "P2_2",
    muxRegOffset: "0x06c",
    options: [ "gpmc_a11", "gmii2_rxd0", "rgmii2_rd0", "rmii2_rxd0", "gpmc_a27", "pr1_mii1_rxer", "mcasp0_axr1", "gpio1_27" ],
    ball: {
        ZCZ: "V17",
        BSM: "T16"
    }
    ...
    key: "P2_4",
    muxRegOffset: "0x068",
    options: [ "gpmc_a10", "gmii2_rxd1", "rgmii2_rd1", "rmii2_rxd1", "gpmc_a26", "pr1_mii1_rxdv", "mcasp0_axr0", "gpio1_26" ],
    ball: {
        ZCZ: "T16",
        BSM: "R15"
    }
    ...
    key: "P2_25",
    muxRegOffset: "0x16c",
    options: [ "uart0_rtsn", "uart4_txd", "dcan1_rx", "i2c1_scl", "spi1_d1", "spi1_cs0", "pr1_edc_sync1_out", "gpio1_9" ],
    ball: {
        ZCZ: "E17",
        BSM: "C13"
    }
    ...
    key: "P2_27",
    muxRegOffset: "0x168",
    options: [ "uart0_ctsn", "uart4_txd", "dcan1_tx", "i2c1_sda", "spi1_d0", "timer7", "pr1_edc_sync0_out", "gpio1_8" ],
    ball: {
        ZCZ: "E18",
        BSM: "C12"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x160",
    options: [ "spi0_cs1", "uart3_rxd", "eCAP1_in_PWM1_out", "mmc0_pow", "xdma_event_intr2", "mmc0_sdcd", "EMU4", "gpio0_6" ],
    ball: {
        ZCZ: "C15",
        BSM: "C14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x148",
    options: [ "mdio_data", "timer6", "uart5_rxd", "uart3_ctsn", "mmc0_sdcd", "mmc1_cmd", "mmc2_cmd", "gpio0_0" ],
    ball: {
        ZCZ: "M17",
        BSM: "E13"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x14c",
    options: [ "mdio_clk", "timer5", "uart5_txd", "uart3_rtsn", "mmc0_wp", "mmc1_clk", "mmc2_clk", "gpio0_1" ],
    ball: {
        ZCZ: "M18",
        BSM: "D13"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x11c",
    options: [ "gmii1_txd3", "NA", "NA", "NA", "NA", "NA", "NA", "gpio0_16" ],
    ball: {
        ZCZ: "J18",
        BSM: "G15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x120",
    options: [ "gmii1_txd2", "NA", "NA", "NA", "NA", "NA", "NA", "gpio0_17" ],
    ball: {
        ZCZ: "K15",
        BSM: "G16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x11c",
    options: [ "USB0_DRVVBUS", "NA", "NA", "NA", "NA", "NA", "NA", "gpio0_18" ],
    ball: {
        ZCZ: "F16",
        BSM: "J15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x124",
    options: [ "gmii1_txd1", "NA", "NA", "NA", "NA", "NA", "NA", "gpio0_21" ],
    ball: {
        ZCZ: "K16",
        BSM: "H14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x128",
    options: [ "gmii1_txd0", "NA", "NA", "NA", "NA", "NA", "NA", "gpio0_28" ],
    ball: {
        ZCZ: "K17",
        BSM: "H15"
    }
    ...
    key: "S1_1_6",
    muxRegOffset: "0x144",
    options: [ "rmii1_refclk", "NA", "spi1_cs0", "NA", "NA", "NA", "NA", "gpio0_28" ],
    ball: {
        ZCZ: "H18",
        BSM: "J14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x134",
    options: [ "gmii1_rxd3", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_18" ],
    ball: {
        ZCZ: "L17",
        BSM: "D14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x138",
    options: [ "gmii1_rxd2", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_19" ],
    ball: {
        ZCZ: "L16",
        BSM: "D15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x13c",
    options: [ "gmii1_rxd1", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_20" ],
    ball: {
        ZCZ: "L15",
        BSM: "D16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x140",
    options: [ "gmii1_rxd0", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_21" ],
    ball: {
        ZCZ: "M16",
        BSM: "E14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x0f0",
    options: [ "mmc0_dat3", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_26" ],
    ball: {
        ZCZ: "F17",
        BSM: "C15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x0f4",
    options: [ "mmc0_dat2", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_27" ],
    ball: {
        ZCZ: "F18",
        BSM: "C16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x0f8",
    options: [ "mmc0_dat1", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_28" ],
    ball: {
        ZCZ: "G15",
        BSM: "A15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x0fc",
    options: [ "mmc0_dat0", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_29" ],
    ball: {
        ZCZ: "G16",
        BSM: "A16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x100",
    options: [ "mmc0_clk", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_30" ],
    ball: {
        ZCZ: "G17",
        BSM: "B15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x104",
    options: [ "mmc0_cmd", "NA", "NA", "NA", "NA", "NA", "NA", "gpio2_31" ],
    ball: {
        ZCZ: "G18",
        BSM: "B16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x108",
    options: [ "gmii1_col", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_0" ],
    ball: {
        ZCZ: "H16",
        BSM: "F15"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x114",
    options: [ "gmii1_txen", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_3" ],
    ball: {
        ZCZ: "J16",
        BSM: "G14"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x118",
    options: [ "gmii1_rxdv", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_4" ],
    ball: {
        ZCZ: "J17",
        BSM: "F16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x188",
    options: [ "I2C0_SDA", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_5" ],
    ball: {
        ZCZ: "C17",
        BSM: "C11"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x18c",
    options: [ "I2C0_SCL", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_6" ],
    ball: {
        ZCZ: "C16",
        BSM: "C10"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x1e4",
    options: [ "EMU0", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_7" ],
    ball: {
        ZCZ: "C14",
        BSM: "E2"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x1e8",
    options: [ "EMU1", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_8" ],
    ball: {
        ZCZ: "B14",
        BSM: "E3"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x12c",
    options: [ "gmii1_txclk", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_9" ],
    ball: {
        ZCZ: "K18",
        BSM: "H16"
    }
    ...
    eeprom: null,
    muxRegOffset: "0x130",
    options: [ "gmii1_rxclk", "NA", "NA", "NA", "NA", "NA", "NA", "gpio3_10" ],
    ball: {
        ZCZ: "L18",
        BSM: "E16"
    }
...
_$jscmd("src/bone.js", "line", 2956);

var pins = {};

for (var i in pinIndex) {
    if (_$jscmd("src/bone.js", "cond", "2958_8_30", Array.isArray(pinIndex[i].key))) {
        for (var j = 0; j < pinIndex[i].key.length; j++) {
            _$jscmd("src/bone.js", "line", 2960);
            var myKey = pinIndex[i].key[j];
            _$jscmd("src/bone.js", "line", 2962);
            //console.log("key[" + j + "].[" + myKey + "]: " + i);
            pins[myKey] = i;
        }
    } else if (_$jscmd("src/bone.js", "cond", "2964_15_33", typeof pinIndex[i] != "undefined")) {
        _$jscmd("src/bone.js", "line", 2965);
        pins[pinIndex[i].key] = i;
    }
    if (_$jscmd("src/bone.js", "cond", "2967_8_35", typeof pinIndex[i].gpio == "number")) {
        _$jscmd("src/bone.js", "line", 2968);
        pins["GPIO_" + pinIndex[i].gpio] = i;
    }
    if (_$jscmd("src/bone.js", "cond", "2970_8_37", typeof pinIndex[i].eeprom == "number")) {
        _$jscmd("src/bone.js", "line", 2971);
        pins["EEPROM_" + pinIndex[i].eeprom] = i;
    }
    if (_$jscmd("src/bone.js", "cond", "2973_8_34", typeof pinIndex[i].ain == "number")) {
        _$jscmd("src/bone.js", "line", 2974);
        pins["A" + pinIndex[i].ain] = i;
    }
    if (_$jscmd("src/bone.js", "cond", "2976_8_43", typeof pinIndex[i].muxRegOffset == "string")) {
        _$jscmd("src/bone.js", "line", 2977);
        var offset = pinIndex[i].muxRegOffset.toUpperCase();
        _$jscmd("src/bone.js", "line", 2978);
        pins["MUX_" + offset] = i;
    }
}

_$jscmd("src/bone.js", "line", 2982);
...
_$jscmd("src/bone.js", "line", 3028);

var getPinObject = function(key) {
    if (_$jscmd("src/bone.js", "cond", "3029_8_22", typeof key == "string")) {
        _$jscmd("src/bone.js", "line", 3031);
        // Ignore case
        key = key.toUpperCase();
        _$jscmd("src/bone.js", "line", 3033);
        // Replace alternate separators and leading zeros
        key = key.replace(/[\.\-_ ]0*/g, "_");
    }
    if (_$jscmd("src/bone.js", "cond", "3035_8_22", typeof key == "number")) {
        _$jscmd("src/bone.js", "line", 3036);
        key = "GPIO_" + key;
    }
    //console.log(key);
    //console.log(pins[key]);
    if (_$jscmd("src/bone.js", "cond", "3040_8_38", typeof pinIndex[pins[key]] == "object")) {
        _$jscmd("src/bone.js", "line", 3041);
        var pinObject = Object.assign({}, pinIndex[pins[key]]);
        // Only keep the matching index led
        if (_$jscmd("src/bone.js", "cond", "3044_12_13", pinObject.led)) {
            //console.log("pinObject[" + key + "]: " + JSON.stringify(pinObject));
            if (_$jscmd("src/bone.js", "cond", "3046_16_28", Array.isArray(pinObject.led))) {
                _$jscmd("src/bone.js", "line", 3048);
                //console.log("pinObject.key: " + pinObject.key);
                var i = pinObject.key.indexOf(key);
                if (_$jscmd("src/bone.js", "cond", "3049_20_6", i >= 0)) {
                    _$jscmd("src/bone.js", "line", 3050);
                    var led = pinObject.led[i];
                    _$jscmd("src/bone.js", "line", 3051);
                    pinObject.led = led;
                } else {
                    _$jscmd("src/bone.js", "line", 3054);
                    pinObject.led = null;
                }
            }
        }
        _$jscmd("src/bone.js", "line", 3060);
        // Remove other keys
        pinObject.key = key;
    } else {
        _$jscmd("src/bone.js", "line", 3062);
        return null;
    }
    _$jscmd("src/bone.js", "line", 3065);
    return pinObject;
};

_$jscmd("src/bone.js", "line", 3068);

var getPinKeys = function(filter) {
    _$jscmd("src/bone.js", "line", 3069);
    var keys = [];
    for (var key in pins) {
        if (_$jscmd("src/bone.js", "cond", "3071_12_28", typeof filter != "undefined")) {
            if (_$jscmd("src/bone.js", "cond", "3072_16_23", key.search(filter) >= 0)) {
                _$jscmd("src/bone.js", "line", 3073);
                keys.push(key);
            }
        } else {
            _$jscmd("src/bone.js", "line", 3076);
            keys.push(key);
        }
    }
    _$jscmd("src/bone.js", "line", 3079);
    return keys;
};

_$jscmd("src/bone.js", "line", 3083);

// from https://stackoverflow.com/questions/15478954/sort-array-elements-string-with-numbers-natural-sort
var naturalCompare = function(a, b) {
    _$jscmd("src/bone.js", "line", 3084);
    var ax = [], bx = [];
    _$jscmd("src/bone.js", "line", 3087);
    a.replace(/(\d+)|(\D+)/g, function(_, $1, $2) {
        _$jscmd("src/bone.js", "line", 3088);
        ax.push([ _$jscmd("src/bone.js", "cond", "3088_17_2", $1) || _$jscmd("src/bone.js", "cond", "3088_23_8", Infinity), _$jscmd("src/bone.js", "cond", "3088_33_2", $2) || "" ]);
    });
    _$jscmd("src/bone.js", "line", 3090);
    b.replace(/(\d+)|(\D+)/g, function(_, $1, $2) {
        _$jscmd("src/bone.js", "line", 3091);
        bx.push([ _$jscmd("src/bone.js", "cond", "3091_17_2", $1) || _$jscmd("src/bone.js", "cond", "3091_23_8", Infinity), _$jscmd("src/bone.js", "cond", "3091_33_2", $2) || "" ]);
    });
    while (_$jscmd("src/bone.js", "cond", "3094_11_9", ax.length) && _$jscmd("src/bone.js", "cond", "3094_24_9", bx.length)) {
        _$jscmd("src/bone.js", "line", 3095);
        var an = ax.shift();
        _$jscmd("src/bone.js", "line", 3096);
        var bn = bx.shift();
        _$jscmd("src/bone.js", "line", 3097);
        var nn = _$jscmd("src/bone.js", "cond", "3097_17_15", an[0] - bn[0]) || _$jscmd("src/bone.js", "cond", "3097_36_26", an[1].localeCompare(bn[1]));
        if (_$jscmd("src/bone.js", "cond", "3098_12_2", nn)) return nn;
    }
    _$jscmd("src/bone.js", "line", 3101);
    return ax.length - bx.length;
};

_$jscmd("src/bone.js", "line", 3106);
